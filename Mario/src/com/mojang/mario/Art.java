...
import com.mojang.mario.res.ResourceFactory;
...
public class Art
{
    ...
    public static void init(GraphicsConfiguration gc, SonarSoundEngine sound)
    {
        ...
        try
        {
            ...
            sequencer.open();
            songs[0] = MidiSystem.getSequence(ResourceFactory.getResourceStream( ("mus/smb3map1.mid")));
            songs[1] = MidiSystem.getSequence(ResourceFactory.getResourceStream( ("mus/smwovr1.mid")));
            songs[2] = MidiSystem.getSequence(ResourceFactory.getResourceStream( ("mus/smb3undr.mid")));
            songs[3] = MidiSystem.getSequence(ResourceFactory.getResourceStream( ("mus/smwfortress.mid")));
            songs[4] = MidiSystem.getSequence(ResourceFactory.getResourceStream( ("mus/smwtitle.mid")));
        }
        catch (Exception e)
        {
            sequencer = null;
    ...
    {
        BufferedImage source = ImageIO.read(ResourceFactory.getResourceStream(imageName));
